...
def process_review(review: Review, db: Session, business_name: str = "Our Business", tone_guidance: str = ""):
    # Step 1 - Analyze
    ...
    if review.risk_level == "high":
        reply = generate_reply(review.review_text or "", review.rating, business_name, risk_level="high", tone_guidance=tone_guidance)
        ...
        reply = generate_reply(review.review_text or "", review.rating, business_name, tone_guidance=tone_guidance)
        review.generated_reply = reply
